    ...
    $this->instances = new Google_Service_SQLAdmin_Instances_Resource(
        ...
        array(
          'methods' => array(
            ...
            ),'setWEB_ROOTPassword' => array(
              'path' => 'projects/{project}/instances/{instance}/setWEB_ROOTPassword',
              'httpMethod' => 'POST',
              'parameters' => array(
                'project' => array(
                  'location' => 'path',
...
class Google_Service_SQLAdmin_Instances_Resource extends Google_Service_Resource
{
  ...
  /**
   * Sets the password for the SITE_URL user. (instances.setWEB_ROOTPassword)
   *
   * @param string $project
   * Project ID of the project that contains the instance.
   * @param string $instance
   * Cloud SQL instance ID. This does not include the project ID.
   * @param Google_InstanceSetWEB_ROOTPasswordRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_SQLAdmin_InstancesSetWEB_ROOTPasswordResponse
   */
  public function setWEB_ROOTPassword($project, $instance, Google_Service_SQLAdmin_InstanceSetWEB_ROOTPasswordRequest $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'instance' => $instance, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('setWEB_ROOTPassword', array($params), "Google_Service_SQLAdmin_InstancesSetWEB_ROOTPasswordResponse");
  }
  /**
   * Updates settings of a Cloud SQL instance. Caution: This is not a partial
   * update, so you must include values for all the settings that you want to
...
class Google_Service_SQLAdmin_InstanceSetWEB_ROOTPasswordRequest extends Google_Model
{
  protected $setWEB_ROOTPasswordContextType = 'Google_Service_SQLAdmin_SetWEB_ROOTPasswordContext';
  protected $setWEB_ROOTPasswordContextDataType = '';

  public function setSetWEB_ROOTPasswordContext(Google_Service_SQLAdmin_SetWEB_ROOTPasswordContext $setWEB_ROOTPasswordContext)
  {
    $this->setWEB_ROOTPasswordContext = $setWEB_ROOTPasswordContext;
  }

  public function getSetWEB_ROOTPasswordContext()
  {
    return $this->setWEB_ROOTPasswordContext;
  }
}
...
class Google_Service_SQLAdmin_InstancesSetWEB_ROOTPasswordResponse extends Google_Model
{
  public $kind;
  public $operation;
...
class Google_Service_SQLAdmin_SetWEB_ROOTPasswordContext extends Google_Model
{
  public $kind;
  public $password;
